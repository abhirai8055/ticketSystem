...
//           console.log(
//             `Ticket ID: ${ticket.ticketId}, Raw Priority: ${ticket.priority}, Normalized Priority: ${ticket.priority || 'N/A'}`,
//           );
//           return {
//             ...ticket,
//             categoryName: categoryMap[ticket.category] || 'N/A',
//             priority: ticket.priority || 'N/A', // Keep original case or default to 'N/A'
...
//                       item.priority.toLowerCase() === 'low' && styles.priorityLow,
  ...
  useEffect(() => {
    const fetchTickets = async () => {
      try {
        ...
        // Fetch engineer names from users collection with debugging
        ...
        if (engineerIds.length > 0) {
          ...
          const usersQuery = query(
            usersRef,
            where('uid', 'in', engineerIds.slice(0, 10)),
          );
